...
% independent of $d, L, n$ such that with high probability over the recalibration samples $(\ce(g))^2 \leq \min_{g' \in \G{}}(\ce(g'))^2 + \frac{cLd \log{R}}{\sqrt{n}}$, where recall that $g \in \G{}$ was selected as the empirical risk minimizer of the mean-squared error loss.
\end{lemma}
