...
\emph{We find that an alternative estimator introduced in the meteorological literature has sample complexity that scales with $\sqrt{B}$ (Theorem~\ref{thm:final-ours})}.
