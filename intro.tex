...
The objective is to maximize \tm{maximize?}the mean-squared error, also known as the Brier score~\cite{brier1950verification}, subject to a calibration constraint\tm{'calibration constraint' -> "calibration error budget"?}.
