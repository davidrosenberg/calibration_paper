...
For any binning scheme $\bins{}$, $p \geq 1$, and continuous bijective function $f : [0, 1] \to [0, 1]$, there exists a distribution \pl{mathbb}$P$ over $\mathcal{X}, \mathcal{Y}$ s.t. $\lpce(f_{\bins{}}) = 0$ but $\lpce(f) \geq 0.49$.
