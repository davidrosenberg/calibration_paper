...
\newcommand{\expect}[0]{\ensuremath{\mathop{\mathbb{E}}}}
...
\begin{abstract}
  ...
  % We then show that methods used to estimate calibration error are suboptimal---we prove that an alternative estimator introduced in the meteorological community requires fewer samples ($O(\sqrt{B})$ instead of $O(B)$).
