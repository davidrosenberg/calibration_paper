...
We validate our approach with multiclass calibration experiments on CIFAR-10 and ImageNet, where we get a 35\% lower calibration error than histogram binning and guarantees on true calibration unlike scaling methods.
