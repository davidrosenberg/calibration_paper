...
\tm{My style would be that some of these definitions, e.g, 3.1 and 3.3, can be just mentioned in texts without a definition environment}

% \begin{definition}
% Given $f$ and $\mathcal{B}$ the binned $\ell_p$ calibration error is given by:
% \[ \lpce(f, B) = \lpce(f_B) \]
% \end{definition}
