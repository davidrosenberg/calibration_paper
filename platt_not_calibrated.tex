...
For any binning scheme $\bins{}$, $p \in \mathbb{Z}^+$, and continuous increasing bijective function $f : [0, 1] \to [0, 1]$, there exists a distribution $P$ over $X, Y$ s.t. $\lpce(f_{\bins{}}) = 0$ but $\lpce(f) \geq 0.49$.
