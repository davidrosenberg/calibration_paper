...
\tnote{changed mbox to textup in the macro, because mbox does different things in theorem environments from texts. I think there are still mbox\{MSE\} as well somewhere not in a macro}
