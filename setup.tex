...
\tm{by quickly skimming the rest of the paper, I didn't see \margsquaredce and \topsquaredce showing up again. If they are only need for experimetns, we could define there instead of here?}
